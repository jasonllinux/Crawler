...
class MySqlHelper:
    ...
    def newConn(self, host,user, passwd,defaultdb):
    ...
    def query(self, sqltext, mode=STORE_RESULT_MODE):
       ...
       """
        ...
        if mode == 0:
            ...
            raise Exception("Mode Value is Valid")
    ...
    def fetchExecuteResult(self, cursor, mode=FETCH_ONE, rows=1):
        """
          作用：提取cursor获取的数据集
          参数：cursor：游标
               mode：执行提取模式
...
if __name__ == "__main__":
    print "This is Crawler MySql Helper"
